...
<html lang="en">
  <head>
    ...
    <title>Bbblog - Default Theme Preview</title>

    <!-- Bootstrap core CSS -->
    <link href="/themes/default/main.min.css" rel="stylesheet">
      ...
      <div class="page-header" id="banner">
        <div class="row">
          <div class="col-lg-8 col-md-7 col-sm-6">
            <a href="/">BACK HOME</a>
            <h1>Default</h1>
            <p class="lead">Preview of Blablablog Theme</p>
          </div>
    ...
    <script src="/themes/<?php echo config('b3_config.theme'); ?>/jquery.min.js"></script>
    <script src="/themes/<?php echo config('b3_config.theme'); ?>/base.min.js"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="/themes/<?php echo config('b3_config.theme'); ?>/ie10-viewport-bug-workaround.js"></script>
  </body>
</html>
