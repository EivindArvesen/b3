...
@section('content')
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            <h2 class="blog-post-title"><a href="<?php echo '/blog/2015/10/09/yeah'; ?>">Sample blog post</a></h2>
    ...
    <a href="/blog/tag/tag" class="label label-info">Tag</a>&nbsp;
          ...
          <div class="blog-post">
            <h2 class="blog-post-title"><a href="<?php echo '/blog/2015/10/09/yeah'; ?>">Another blog post</a></h2>
            <p class="blog-post-meta"><?php date_links(['2015', '10', '09'], "span"); ?>by <a href="#"><?php echo config('bbb_config.user') ?></a></p>
    ...
    <a href="/blog/tag/tag" class="label label-info">Tag</a>&nbsp;
          ...
          <div class="blog-post">
            <h2 class="blog-post-title"><a href="<?php echo '/blog/2015/10/09/yeah'; ?>">New feature</a></h2>
            <p class="blog-post-meta"><?php date_links(['2015', '10', '09'], "span"); ?>by <a href="#"><?php echo config('bbb_config.user') ?></a></p>
