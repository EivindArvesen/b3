...
class PageController extends Controller {
    ...
    public function index()
    {
        ...
        return view('front.' . $page->type, ['page_title' => $page->page_title, 'bg' => $page->bg, 'menu_transparent' => false, 'style' => $page->style, 'nav_active' => '', 'page' => $page, 'last_blogposts' => $last_blogposts, 'last_projects' => $last_projects, 'keywords' => array($page->page_title)]);
    }
    ...
    public function page($slug)
    {
        ...
        if ($page->type == 'index') {
            ...
            return view('front.' . $page->type, ['page_title' => $page->page_title, 'bg' => $page->bg, 'nav_active' => $page->slug, 'page' => $page, 'keywords' => array($page->page_title)]);
        }
